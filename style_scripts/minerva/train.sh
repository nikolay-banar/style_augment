CONTENT_PATH=/home/ubuntu/pycharmProjects/style_transfer/classification_of_crops/images/style/train
STYLE_PATH=/home/ubuntu/pycharmProjects/style_transfer/classification_of_crops/images/style/train
SAVE_ROOT=/home/ubuntu/pycharmProjects/style_transfer/classification_of_crops/images/minerva/augmented
...
for INST in "Harp (3285)" "Lute (3394)" "Violin (3573)"; do
  ...
  for f in "${STYLE_FILES[@]}"; do
  CUDA_VISIBLE_DEVICES=0 arbitrary_image_stylization_with_weights \
